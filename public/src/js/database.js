...
// Change column name
// sql = 'ALTER TABLE Orders RENAME COLUMN datum TO date';
// db.run(sql, (err) => {
//         if (err) return console.error(err.message);
// })
...
// Add column to table
// sql = 'ALTER TABLE Movies ADD COLUMN price INTEGER NOT NULL DEFAULT 0';
// db.run(sql, (err) => {
//         if (err) return console.error(err.message);
// })
...
// db.run(sql, ['12,50', 11111], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ['12,50', 21112], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["12,50", 31113], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["14,00", 41114], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["14,00", 51115], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["15,50", 61116], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["15,50", 71117], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["10,00", 81118], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["15,50", 91119], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["13,00", 12121], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["9,50", 22122], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["11,50", 32123], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["11,50", 42124], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["10,00", 52125], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["10,00", 62126], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["12,50", 72127], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["12,50", 82128], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["12,50", 92129], (err) => {
//         if(err) return console.error(err.message); 
// }); 

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["14,50", 13131], (err) => {
//         if(err) return console.error(err.message); 
// });

// sql = "UPDATE Movies SET price = ? WHERE movie_ID = ?";
// db.run(sql, ["14,50", 23132], (err) => {
//         if(err) return console.error(err.message); 
// }); 
